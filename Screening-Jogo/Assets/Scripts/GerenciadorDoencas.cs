...
public class GerenciadorDoencas : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            new Doenca("Ressaca", new List<string> { "dor de cabeça", "fotofobia", "sede", "tontura", "desorientação", "ânsia" }, "Participou de uma festa ontem à noite", "Soro em cápsula"),
            new Doenca("Picada de Aranha", new List<string> { "dor intensa", "inchaço", "náusea", "vômito", "febre", "suor excessivo" }, "Estava arrumando caixas na garagem", "Anti-histamínico"),
